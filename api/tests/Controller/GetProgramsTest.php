...
class GetProgramsTest extends WebTestCase
{
    ...
    public function testGetAllPrograms(): void
    {
        ...
        $program2->setTag('Grado Superior');
        ...
        $this->assertEquals('Grado Superior', $program2->getTag());
    ...
    public function testGetProgramsByField(): void
    {
        ...
        $program3->setTag('Grado Superior');
    ...
    public function testGetProgramByFieldName(): void
    {
        $field = new Field();
        $field->setId(Uuid::fromString('0edbed88-f546-4bee-b16a-035c16abc5b4'));
        $field->setName('Informática y Comunicaciones');
        ...
        $this->client->request("GET", "/api/programs/field/name/informatica-y-comunicaciones");
        $response = $this->client->getResponse();
        $content = $response->getContent();
        $programs = json_decode($content, true);
    ...
    public function testGetProgramById(): void
    {
        ...
        $this->client->request("GET", "/api/programs/08743d2a-d22c-4272-b804-5c91d44dd079");
        $response = $this->client->getResponse();
        $content = $response->getContent();
    ...
    public function testGetProgramByName(): void
    {
        $program = new Program();
        $program->setId(Uuid::fromString('08743d2a-d22c-4272-b804-5c91d44dd079'));
        $program->setName('Técnico Superior en Administracion de Sistemas Informáticos en Red');
